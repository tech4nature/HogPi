...
if __name__ == "__main__":
    ...
    rectime = "10"  # record time output_folder 10s
    ...
    ffmpeg1.wait()
    arec.terminate()
    irled.off()  # Turn led output_folderf

    # ffprobe to extract recording time and date and turn into output_folderfset seconds
    command = [
        "ffprobe",
        "-v",
        "error",
